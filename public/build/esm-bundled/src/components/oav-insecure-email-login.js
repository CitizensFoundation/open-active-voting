...
if(!!this.inputElement.bindValue){this.$.container._handleValueAndAutoValidate(this.inputElement)}}});const OavInsecureEmailLoginStyles=css`
  paper-dialog {
    padding-left: 8px;
    padding-right: 8px;
    width: 440px;
