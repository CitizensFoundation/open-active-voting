define(["exports","../oav-app.js"],function(_exports,_oavApp){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ypTruncateBehavior=_exports.ypRemoveClassBehavior=_exports.ypNumberFormatBehavior=_exports.ypMediaFormatsBehavior=_exports.ypLocalizationBridgeBehavior=_exports.ypIronListBehavior=_exports.YpPostBehavior=_exports.$ypTruncateBehavior=_exports.$ypRemoveClassBehavior=_exports.$ypPostBehaviors=_exports.$ypNumberFormatBehavior=_exports.$ypMediaFormatsBehavior=_exports.$ypLocalizationBridgeBehavior=_exports.$ypIronListBehavior=_exports.$esmDefault=_exports.$esm=void 0;(0,_oavApp.Polymer)({is:"iron-request",hostAttributes:{hidden:!0},properties:{/**
...
<div id="radioLabel"><slot></slot></div>`;template$1.setAttribute("strip-whitespace","");/**
                                                 ...
                                                 @demo demo/index.html
                                                 */(0,_oavApp.Polymer)({_template:template$1,is:"paper-radio-button",behaviors:[_oavApp.PaperCheckedElementBehavior],hostAttributes:{role:"radio","aria-checked":!1,tabindex:0},properties:{/**
