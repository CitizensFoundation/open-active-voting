define(["exports","../oav-app.js"],function(_exports,_oavApp){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.ypTruncateBehavior=_exports.ypRemoveClassBehavior=_exports.ypNumberFormatBehavior=_exports.ypMediaFormatsBehavior=_exports.ypLocalizationBridgeBehavior=_exports.ypIronListBehavior=_exports.YpPostBehavior=_exports.PaperCheckedElementBehaviorImpl=_exports.PaperCheckedElementBehavior=_exports.IronValidatableBehaviorMeta=_exports.IronValidatableBehavior=_exports.IronFormElementBehavior=_exports.IronCheckedElementBehaviorImpl=_exports.IronCheckedElementBehavior=_exports.$ypTruncateBehavior=_exports.$ypRemoveClassBehavior=_exports.$ypPostBehaviors=_exports.$ypNumberFormatBehavior=_exports.$ypMediaFormatsBehavior=_exports.$ypLocalizationBridgeBehavior=_exports.$ypIronListBehavior=_exports.$paperCheckedElementBehavior=_exports.$ironValidatableBehavior=_exports.$ironFormElementBehavior=_exports.$ironCheckedElementBehavior=_exports.$esmDefault=_exports.$esm=void 0;(0,_oavApp.Polymer)({is:"iron-request",hostAttributes:{hidden:!0},properties:{/**
...
if(null===str||str===void 0||!str.toString){return""}return encodeURIComponent(str.toString().replace(/\r?\n/g,"\r\n")).replace(/%20/g,"+")},/**
   ...
   */_updateStatus:function(){this._setStatus(this.xhr.status);this._setStatusText(this.xhr.statusText===void 0?"":this.xhr.statusText)}});(0,_oavApp.Polymer)({is:"iron-ajax",/**
...
attached:function(){},detached:function(){}};_exports.IronFormElementBehavior=IronFormElementBehavior;var ironFormElementBehavior={IronFormElementBehavior:IronFormElementBehavior};_exports.$ironFormElementBehavior=ironFormElementBehavior;let IronValidatableBehaviorMeta=null;/**
...
`,is:"iron-list",properties:{/**
     ...
     */scrollOffset:{type:Number,value:0}},observers:["_itemsChanged(items.*)","_selectionEnabledChanged(selectionEnabled)","_multiSelectionChanged(multiSelection)","_setOverflow(scrollTarget, scrollOffset)"],behaviors:[_oavApp.Templatizer,_oavApp.IronResizableBehavior,_oavApp.IronScrollTargetBehavior,_oavApp.OptionalMutableDataBehavior],/**
   ...
   */get _itemsParent(){return(0,_oavApp.dom)((0,_oavApp.dom)(this._userTemplate).parentNode)},/**
...
this._lastVisibleIndexVal=null;this._firstVisibleIndexVal=null;this._debounce("_render",this._render,_oavApp.animationFrame)},/**
...
}else if(!this._isClientFull()){this._debounce("_increasePoolIfNeeded",this._increasePoolIfNeeded.bind(this,nextIncrease),_oavApp.microTask)}else if(this._physicalSize<this._optPhysicalSize){// Yield and increase the pool during idle time until the physical size is
// optimal.
this._debounce("_increasePoolIfNeeded",this._increasePoolIfNeeded.bind(this,this._clamp(Math.round(50/this._templateCost),1,nextIncrease)),_oavApp.idlePeriod)}},/**
...
if(forceUpdate||Math.abs(this._estScrollHeight-this._scrollHeight)>=this._viewportHeight){this.$.items.style.height=this._estScrollHeight+"px";this._scrollHeight=this._estScrollHeight}},/**
   ...
   */scrollToIndex:function(idx){if("number"!==typeof idx||0>idx||idx>this.items.length-1){return}(0,_oavApp.flush)();// Items should have been rendered prior scrolling to an index.
...
this.toggleScrollListener(!1)}},_oavApp.animationFrame)},/**
...
if(!focusable){focusable=(0,_oavApp.dom)(physicalItem).querySelector("[tabindex=\""+SECRET_TABINDEX+"\"]")}// restore the tab index
...
<div id="radioLabel"><slot></slot></div>`;template$1.setAttribute("strip-whitespace","");/**
                                                 ...
                                                 @demo demo/index.html
                                                 */(0,_oavApp.Polymer)({_template:template$1,is:"paper-radio-button",behaviors:[PaperCheckedElementBehavior],hostAttributes:{role:"radio","aria-checked":!1,tabindex:0},properties:{/**
...
(0,_oavApp.afterNextRender)(this,function(){var inkSize=this.getComputedStyleValue("--calculated-paper-radio-button-ink-size").trim();// If unset, compute and set the default `--paper-radio-button-ink-size`.
...
// centers align.
if(defaultInkSize%2!==size%2){defaultInkSize++}this.updateStyles({"--paper-radio-button-ink-size":defaultInkSize+"px"})}})}});(0,_oavApp.Polymer)({_template:_oavApp.html`
    <style>
      :host {
        display: inline-block;
      }
    ...
    <slot></slot>
`,is:"paper-radio-group",behaviors:[_oavApp.IronMenubarBehavior],/** @private */hostAttributes:{role:"radiogroup"},properties:{/**
