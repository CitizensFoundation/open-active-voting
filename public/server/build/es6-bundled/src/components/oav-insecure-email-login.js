define(["exports","./oav-app.js"],function(_exports,_oavApp){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.OavInsecureEmailLoginStyles=_exports.PaperInputBehavior=_exports.PaperInputBehaviorImpl=_exports.PaperInputHelper=_exports.PaperInputAddonBehavior=_exports.IronA11yAnnouncer=_exports.$oavInsecureEmailLoginStyles=_exports.$paperInputBehavior=_exports.$paperInputAddonBehavior=_exports.$ironA11yAnnouncer=void 0;const IronA11yAnnouncer=(0,_oavApp.Polymer)({_template:_oavApp.html`
    <style>
      :host {
...
`;template$1.setAttribute("style","display: none;");document.head.appendChild(template$1.content);(0,_oavApp.Polymer)({_template:_oavApp.html`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
`,is:"paper-input-error",behaviors:[PaperInputAddonBehavior],properties:{invalid:{readOnly:!0,reflectToAttribute:!0,type:Boolean}},update:function(state){this._setInvalid(state.invalid)}});(0,_oavApp.Polymer)({is:"paper-input",_template:_oavApp.html`
    <style>
      :host {
        display: block;
      }
  ...
  `,behaviors:[PaperInputBehavior,_oavApp.IronFormElementBehavior],properties:{value:{type:String}},get _focusableElement(){return this.inputElement._inputElement},listeners:{"iron-input-ready":"_onIronInputReady"},_onIronInputReady:function(){if(!this.$.nativeInput){this.$.nativeInput=this.$$("input")}if(this.inputElement&&-1!==this._typesThatHaveText.indexOf(this.$.nativeInput.type)){this.alwaysFloatLabel=!0}if(!!this.inputElement.bindValue){this.$.container._handleValueAndAutoValidate(this.inputElement)}}});const OavInsecureEmailLoginStyles=_oavApp.css`
  paper-dialog {
    padding-left: 8px;
    padding-right: 8px;
    width: 440px;
