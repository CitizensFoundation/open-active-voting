...
class ReykjavikBudgetBallot
  ALLOWED_BALLOT_CHARACTERS = ('a'..'z').to_a+['0','1','2','3']
  ...
  def initialize(neighborhood_id=1)
    ...
    @neighborhoods[3][:priorities] << {:id=>83, :letter=>"", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/2290-lagfaeringar-a-geirsnefi", :description=>I18n.t(:new_project_description_id_83), :name=>I18n.t(:new_project_name_id_83), :price=>5.0}
    @neighborhoods[3][:priorities] << {:id=>84, :letter=>"", :link=>"http://betrireykjavik.is/ideas/1801-gangbrautarljos-a-fjallkonuveg-vid-joklafold", :description=>I18n.t(:new_project_description_id_84), :name=>I18n.t(:new_project_name_id_84), :price=>12.0}
    @neighborhoods[3][:priorities] << {:id=>85, :letter=>"", :link=>"http://betrireykjavik.is/ideas/1862-setja-upp-hlid-a-gongustig-a-milli-rimaskola-og-midgardslangarima-vegna-mikillar-motorhjolaumferdar-um-gangstiginn", :description=>I18n.t(:new_project_description_id_85), :name=>I18n.t(:new_project_name_id_85), :price=>0.7}
    @neighborhoods[3][:priorities] << {:id=>86, :letter=>"", :link=>"http://betrireykjavik.is/ideas/1944-gangbrautarljos-vid-gagnveg-i-grafarvogi", :description=>I18n.t(:new_project_description_id_86), :name=>I18n.t(:new_project_name_id_86), :price=>12.0}
    @neighborhoods[3][:priorities] << {:id=>87, :letter=>"", :link=>"http://betrireykjavik.is/ideas/2157-malbika-malarstig-milli-hamrahverfis-ad-gufunesbaejar", :description=>I18n.t(:new_project_description_id_87), :name=>I18n.t(:new_project_name_id_87), :price=>10.0}
    @neighborhoods[3][:priorities] << {:id=>88, :letter=>"", :link=>"http://betrireykjavik.is/ideas/2174-haekkun-hljodmanar-milli-stakkhamra-og-gullinbruarstrandvegar", :description=>I18n.t(:new_project_description_id_88), :name=>I18n.t(:new_project_name_id_88), :price=>6.0}
    ...
    @neighborhoods[5][:priorities] << {:id=>114, :letter=>"z", :link=>"", :description=>I18n.t(:new_project_description_id_114), :name=>I18n.t(:new_project_name_id_114), :price=>2.0}
    @neighborhoods[5][:priorities] << {:id=>115, :letter=>"0", :link=>"", :description=>I18n.t(:new_project_description_id_115), :name=>I18n.t(:new_project_name_id_115), :price=>7.0}
    @neighborhoods[5][:priorities] << {:id=>116, :letter=>"1", :link=>"", :description=>I18n.t(:new_project_description_id_116), :name=>I18n.t(:new_project_name_id_116), :price=>0.5}
    ...
    @neighborhoods[6][:priorities] << {:id=>119, :letter=>"a", :link=>"", :description=>I18n.t(:new_project_description_id_119), :name=>I18n.t(:new_project_name_id_119), :price=>1.0}
    @neighborhoods[6][:priorities] << {:id=>120, :letter=>"b", :link=>"", :description=>I18n.t(:new_project_description_id_120), :name=>I18n.t(:new_project_name_id_120), :price=>7.5}
    @neighborhoods[6][:priorities] << {:id=>121, :letter=>"c", :link=>"", :description=>I18n.t(:new_project_description_id_121), :name=>I18n.t(:new_project_name_id_121), :price=>0.3}
    @neighborhoods[6][:priorities] << {:id=>122, :letter=>"d", :link=>"", :description=>I18n.t(:new_project_description_id_122), :name=>I18n.t(:new_project_name_id_122), :price=>7.0}
    @neighborhoods[6][:priorities] << {:id=>123, :letter=>"e", :link=>"", :description=>I18n.t(:new_project_description_id_123), :name=>I18n.t(:new_project_name_id_123), :price=>3.0}
    @neighborhoods[6][:priorities] << {:id=>124, :letter=>"f", :link=>"", :description=>I18n.t(:new_project_description_id_124), :name=>I18n.t(:new_project_name_id_124), :price=>2.0}
    @neighborhoods[6][:priorities] << {:id=>125, :letter=>"g", :link=>"", :description=>I18n.t(:new_project_description_id_125), :name=>I18n.t(:new_project_name_id_125), :price=>3.0}
    @neighborhoods[6][:priorities] << {:id=>126, :letter=>"h", :link=>"", :description=>I18n.t(:new_project_description_id_126), :name=>I18n.t(:new_project_name_id_126), :price=>1.5}
    @neighborhoods[6][:priorities] << {:id=>127, :letter=>"i", :link=>"", :description=>I18n.t(:new_project_description_id_127), :name=>I18n.t(:new_project_name_id_127), :price=>15.0}
    @neighborhoods[6][:priorities] << {:id=>128, :letter=>"j", :link=>"", :description=>I18n.t(:new_project_description_id_128), :name=>I18n.t(:new_project_name_id_128), :price=>8.0}
    @neighborhoods[6][:priorities] << {:id=>129, :letter=>"k", :link=>"", :description=>I18n.t(:new_project_description_id_129), :name=>I18n.t(:new_project_name_id_129), :price=>3.0}
    @neighborhoods[6][:priorities] << {:id=>130, :letter=>"l", :link=>"", :description=>I18n.t(:new_project_description_id_130), :name=>I18n.t(:new_project_name_id_130), :price=>8.0}
    @neighborhoods[6][:priorities] << {:id=>131, :letter=>"m", :link=>"", :description=>I18n.t(:new_project_description_id_131), :name=>I18n.t(:new_project_name_id_131), :price=>5.0}
    @neighborhoods[6][:priorities] << {:id=>132, :letter=>"n", :link=>"", :description=>I18n.t(:new_project_description_id_132), :name=>I18n.t(:new_project_name_id_132), :price=>0.8}
    @neighborhoods[6][:priorities] << {:id=>133, :letter=>"o", :link=>"", :description=>I18n.t(:new_project_description_id_133), :name=>I18n.t(:new_project_name_id_133), :price=>2.0}
    @neighborhoods[6][:priorities] << {:id=>134, :letter=>"p", :link=>"", :description=>I18n.t(:new_project_description_id_134), :name=>I18n.t(:new_project_name_id_134), :price=>3.0}
    @neighborhoods[6][:priorities] << {:id=>135, :letter=>"q", :link=>"", :description=>I18n.t(:new_project_description_id_135), :name=>I18n.t(:new_project_name_id_135), :price=>10.0}
    @neighborhoods[6][:priorities] << {:id=>136, :letter=>"r", :link=>"", :description=>I18n.t(:new_project_description_id_136), :name=>I18n.t(:new_project_name_id_136), :price=>4.0}
    @neighborhoods[6][:priorities] << {:id=>137, :letter=>"s", :link=>"", :description=>I18n.t(:new_project_description_id_137), :name=>I18n.t(:new_project_name_id_137), :price=>10.0}
    ...
    @neighborhoods[7][:priorities] << {:id=>139, :letter=>"a", :link=>"", :description=>I18n.t(:new_project_description_id_139), :name=>I18n.t(:new_project_name_id_139), :price=>4.0}
    @neighborhoods[7][:priorities] << {:id=>140, :letter=>"b", :link=>"", :description=>I18n.t(:new_project_description_id_140), :name=>I18n.t(:new_project_name_id_140), :price=>3.0}
    @neighborhoods[7][:priorities] << {:id=>141, :letter=>"c", :link=>"", :description=>I18n.t(:new_project_description_id_141), :name=>I18n.t(:new_project_name_id_141), :price=>2.0}
    @neighborhoods[7][:priorities] << {:id=>142, :letter=>"d", :link=>"", :description=>I18n.t(:new_project_description_id_142), :name=>I18n.t(:new_project_name_id_142), :price=>2.5}
    @neighborhoods[7][:priorities] << {:id=>143, :letter=>"e", :link=>"", :description=>I18n.t(:new_project_description_id_143), :name=>I18n.t(:new_project_name_id_143), :price=>2.0}
    @neighborhoods[7][:priorities] << {:id=>144, :letter=>"f", :link=>"", :description=>I18n.t(:new_project_description_id_144), :name=>I18n.t(:new_project_name_id_144), :price=>1.5}
    @neighborhoods[7][:priorities] << {:id=>145, :letter=>"g", :link=>"", :description=>I18n.t(:new_project_description_id_145), :name=>I18n.t(:new_project_name_id_145), :price=>0.5}
    @neighborhoods[7][:priorities] << {:id=>146, :letter=>"h", :link=>"", :description=>I18n.t(:new_project_description_id_146), :name=>I18n.t(:new_project_name_id_146), :price=>0.5}
    @neighborhoods[7][:priorities] << {:id=>147, :letter=>"i", :link=>"", :description=>I18n.t(:new_project_description_id_147), :name=>I18n.t(:new_project_name_id_147), :price=>4.0}
    @neighborhoods[7][:priorities] << {:id=>148, :letter=>"j", :link=>"", :description=>I18n.t(:new_project_description_id_148), :name=>I18n.t(:new_project_name_id_148), :price=>2.0}
    @neighborhoods[7][:priorities] << {:id=>149, :letter=>"k", :link=>"", :description=>I18n.t(:new_project_description_id_149), :name=>I18n.t(:new_project_name_id_149), :price=>3.0}
    @neighborhoods[7][:priorities] << {:id=>150, :letter=>"l", :link=>"", :description=>I18n.t(:new_project_description_id_150), :name=>I18n.t(:new_project_name_id_150), :price=>4.0}
    @neighborhoods[7][:priorities] << {:id=>151, :letter=>"m", :link=>"", :description=>I18n.t(:new_project_description_id_151), :name=>I18n.t(:new_project_name_id_151), :price=>1.0}
    @neighborhoods[7][:priorities] << {:id=>152, :letter=>"n", :link=>"", :description=>I18n.t(:new_project_description_id_152), :name=>I18n.t(:new_project_name_id_152), :price=>1.0}
    @neighborhoods[7][:priorities] << {:id=>153, :letter=>"o", :link=>"", :description=>I18n.t(:new_project_description_id_153), :name=>I18n.t(:new_project_name_id_153), :price=>4.0}
    @neighborhoods[7][:priorities] << {:id=>154, :letter=>"p", :link=>"", :description=>I18n.t(:new_project_description_id_154), :name=>I18n.t(:new_project_name_id_154), :price=>0.5}
    @neighborhoods[7][:priorities] << {:id=>155, :letter=>"q", :link=>"", :description=>I18n.t(:new_project_description_id_155), :name=>I18n.t(:new_project_name_id_155), :price=>1.5}
    @neighborhoods[7][:priorities] << {:id=>156, :letter=>"r", :link=>"", :description=>I18n.t(:new_project_description_id_156), :name=>I18n.t(:new_project_name_id_156), :price=>0.3}
    @neighborhoods[7][:priorities] << {:id=>157, :letter=>"s", :link=>"", :description=>I18n.t(:new_project_description_id_157), :name=>I18n.t(:new_project_name_id_157), :price=>0.1}

    @neighborhoods[8][:priorities] << {:id=>158, :letter=>"a", :link=>"", :description=>I18n.t(:new_project_description_id_158), :name=>I18n.t(:new_project_name_id_158), :price=>2.0}
    @neighborhoods[8][:priorities] << {:id=>159, :letter=>"b", :link=>"", :description=>I18n.t(:new_project_description_id_159), :name=>I18n.t(:new_project_name_id_159), :price=>2.0}
    @neighborhoods[8][:priorities] << {:id=>160, :letter=>"c", :link=>"", :description=>I18n.t(:new_project_description_id_160), :name=>I18n.t(:new_project_name_id_160), :price=>1.0}
    @neighborhoods[8][:priorities] << {:id=>161, :letter=>"d", :link=>"", :description=>I18n.t(:new_project_description_id_161), :name=>I18n.t(:new_project_name_id_161), :price=>20.0}
    @neighborhoods[8][:priorities] << {:id=>162, :letter=>"e", :link=>"", :description=>I18n.t(:new_project_description_id_162), :name=>I18n.t(:new_project_name_id_162), :price=>4.0}
    @neighborhoods[8][:priorities] << {:id=>163, :letter=>"f", :link=>"", :description=>I18n.t(:new_project_description_id_163), :name=>I18n.t(:new_project_name_id_163), :price=>4.0}
    @neighborhoods[8][:priorities] << {:id=>164, :letter=>"g", :link=>"", :description=>I18n.t(:new_project_description_id_164), :name=>I18n.t(:new_project_name_id_164), :price=>3.0}
    @neighborhoods[8][:priorities] << {:id=>165, :letter=>"h", :link=>"", :description=>I18n.t(:new_project_description_id_165), :name=>I18n.t(:new_project_name_id_165), :price=>6.0}
    @neighborhoods[8][:priorities] << {:id=>166, :letter=>"i", :link=>"", :description=>I18n.t(:new_project_description_id_166), :name=>I18n.t(:new_project_name_id_166), :price=>3.0}
    @neighborhoods[8][:priorities] << {:id=>167, :letter=>"j", :link=>"", :description=>I18n.t(:new_project_description_id_167), :name=>I18n.t(:new_project_name_id_167), :price=>4.0}
    @neighborhoods[8][:priorities] << {:id=>168, :letter=>"k", :link=>"", :description=>I18n.t(:new_project_description_id_168), :name=>I18n.t(:new_project_name_id_168), :price=>1.0}
    @neighborhoods[8][:priorities] << {:id=>169, :letter=>"l", :link=>"", :description=>I18n.t(:new_project_description_id_169), :name=>I18n.t(:new_project_name_id_169), :price=>0.3}
    @neighborhoods[8][:priorities] << {:id=>170, :letter=>"m", :link=>"", :description=>I18n.t(:new_project_description_id_170), :name=>I18n.t(:new_project_name_id_170), :price=>4.0}
    @neighborhoods[8][:priorities] << {:id=>171, :letter=>"n", :link=>"", :description=>I18n.t(:new_project_description_id_171), :name=>I18n.t(:new_project_name_id_171), :price=>5.0}
    @neighborhoods[8][:priorities] << {:id=>172, :letter=>"o", :link=>"", :description=>I18n.t(:new_project_description_id_172), :name=>I18n.t(:new_project_name_id_172), :price=>3.0}
    @neighborhoods[8][:priorities] << {:id=>173, :letter=>"p", :link=>"", :description=>I18n.t(:new_project_description_id_173), :name=>I18n.t(:new_project_name_id_173), :price=>1.5}
    @neighborhoods[8][:priorities] << {:id=>174, :letter=>"q", :link=>"", :description=>I18n.t(:new_project_description_id_174), :name=>I18n.t(:new_project_name_id_174), :price=>2.0}
    @neighborhoods[8][:priorities] << {:id=>175, :letter=>"r", :link=>"", :description=>I18n.t(:new_project_description_id_175), :name=>I18n.t(:new_project_name_id_175), :price=>5.0}
    @neighborhoods[8][:priorities] << {:id=>176, :letter=>"s", :link=>"", :description=>I18n.t(:new_project_description_id_176), :name=>I18n.t(:new_project_name_id_176), :price=>5.0}
    @neighborhoods[8][:priorities] << {:id=>177, :letter=>"t", :link=>"", :description=>I18n.t(:new_project_description_id_177), :name=>I18n.t(:new_project_name_id_177), :price=>1.0}
    @neighborhoods[8][:priorities] << {:id=>178, :letter=>"u", :link=>"", :description=>I18n.t(:new_project_description_id_178), :name=>I18n.t(:new_project_name_id_178), :price=>2.0}
    @neighborhoods[8][:priorities] << {:id=>179, :letter=>"v", :link=>"", :description=>I18n.t(:new_project_description_id_179), :name=>I18n.t(:new_project_name_id_179), :price=>3.0}
    ...
    @neighborhoods[9][:priorities] << {:id=>184, :letter=>"a", :link=>"", :description=>I18n.t(:new_project_description_id_184), :name=>I18n.t(:new_project_name_id_184), :price=>0.5}
    @neighborhoods[9][:priorities] << {:id=>185, :letter=>"b", :link=>"", :description=>I18n.t(:new_project_description_id_185), :name=>I18n.t(:new_project_name_id_185), :price=>3.0}
    @neighborhoods[9][:priorities] << {:id=>186, :letter=>"c", :link=>"", :description=>I18n.t(:new_project_description_id_186), :name=>I18n.t(:new_project_name_id_186), :price=>2.0}
    @neighborhoods[9][:priorities] << {:id=>187, :letter=>"d", :link=>"", :description=>I18n.t(:new_project_description_id_187), :name=>I18n.t(:new_project_name_id_187), :price=>3.0}
    @neighborhoods[9][:priorities] << {:id=>188, :letter=>"e", :link=>"", :description=>I18n.t(:new_project_description_id_188), :name=>I18n.t(:new_project_name_id_188), :price=>3.0}
    @neighborhoods[9][:priorities] << {:id=>189, :letter=>"f", :link=>"", :description=>I18n.t(:new_project_description_id_189), :name=>I18n.t(:new_project_name_id_189), :price=>12.0}
    @neighborhoods[9][:priorities] << {:id=>190, :letter=>"g", :link=>"", :description=>I18n.t(:new_project_description_id_190), :name=>I18n.t(:new_project_name_id_190), :price=>10.0}
    @neighborhoods[9][:priorities] << {:id=>191, :letter=>"h", :link=>"", :description=>I18n.t(:new_project_description_id_191), :name=>I18n.t(:new_project_name_id_191), :price=>4.0}
    @neighborhoods[9][:priorities] << {:id=>192, :letter=>"i", :link=>"", :description=>I18n.t(:new_project_description_id_192), :name=>I18n.t(:new_project_name_id_192), :price=>2.0}
    @neighborhoods[9][:priorities] << {:id=>193, :letter=>"j", :link=>"", :description=>I18n.t(:new_project_description_id_193), :name=>I18n.t(:new_project_name_id_193), :price=>1.0}
    @neighborhoods[9][:priorities] << {:id=>194, :letter=>"k", :link=>"", :description=>I18n.t(:new_project_description_id_194), :name=>I18n.t(:new_project_name_id_194), :price=>3.0}
    @neighborhoods[9][:priorities] << {:id=>195, :letter=>"l", :link=>"", :description=>I18n.t(:new_project_description_id_195), :name=>I18n.t(:new_project_name_id_195), :price=>2.0}
    @neighborhoods[9][:priorities] << {:id=>196, :letter=>"m", :link=>"", :description=>I18n.t(:new_project_description_id_196), :name=>I18n.t(:new_project_name_id_196), :price=>4.0}
    @neighborhoods[9][:priorities] << {:id=>197, :letter=>"n", :link=>"", :description=>I18n.t(:new_project_description_id_197), :name=>I18n.t(:new_project_name_id_197), :price=>2.0}
    @neighborhoods[9][:priorities] << {:id=>198, :letter=>"o", :link=>"", :description=>I18n.t(:new_project_description_id_198), :name=>I18n.t(:new_project_name_id_198), :price=>3.0}
    ...
    @neighborhoods[10][:priorities] << {:id=>200, :letter=>"a", :link=>"", :description=>I18n.t(:new_project_description_id_200), :name=>I18n.t(:new_project_name_id_200), :price=>1.0}
    @neighborhoods[10][:priorities] << {:id=>201, :letter=>"b", :link=>"", :description=>I18n.t(:new_project_description_id_201), :name=>I18n.t(:new_project_name_id_201), :price=>7.0}
    @neighborhoods[10][:priorities] << {:id=>202, :letter=>"c", :link=>"", :description=>I18n.t(:new_project_description_id_202), :name=>I18n.t(:new_project_name_id_202), :price=>12.0}
    @neighborhoods[10][:priorities] << {:id=>203, :letter=>"d", :link=>"", :description=>I18n.t(:new_project_description_id_203), :name=>I18n.t(:new_project_name_id_203), :price=>2.0}
    @neighborhoods[10][:priorities] << {:id=>204, :letter=>"e", :link=>"", :description=>I18n.t(:new_project_description_id_204), :name=>I18n.t(:new_project_name_id_204), :price=>10.0}
    @neighborhoods[10][:priorities] << {:id=>205, :letter=>"f", :link=>"", :description=>I18n.t(:new_project_description_id_205), :name=>I18n.t(:new_project_name_id_205), :price=>1.0}
    @neighborhoods[10][:priorities] << {:id=>206, :letter=>"g", :link=>"", :description=>I18n.t(:new_project_description_id_206), :name=>I18n.t(:new_project_name_id_206), :price=>5.0}
    @neighborhoods[10][:priorities] << {:id=>207, :letter=>"h", :link=>"", :description=>I18n.t(:new_project_description_id_207), :name=>I18n.t(:new_project_name_id_207), :price=>0.5}
    @neighborhoods[10][:priorities] << {:id=>208, :letter=>"i", :link=>"", :description=>I18n.t(:new_project_description_id_208), :name=>I18n.t(:new_project_name_id_208), :price=>8.0}
    @neighborhoods[10][:priorities] << {:id=>209, :letter=>"j", :link=>"", :description=>I18n.t(:new_project_description_id_209), :name=>I18n.t(:new_project_name_id_209), :price=>0.5}
    @neighborhoods[10][:priorities] << {:id=>210, :letter=>"k", :link=>"", :description=>I18n.t(:new_project_description_id_210), :name=>I18n.t(:new_project_name_id_210), :price=>1.0}
    @neighborhoods[10][:priorities] << {:id=>211, :letter=>"l", :link=>"", :description=>I18n.t(:new_project_description_id_211), :name=>I18n.t(:new_project_name_id_211), :price=>5.0}
    @neighborhoods[10][:priorities] << {:id=>212, :letter=>"m", :link=>"", :description=>I18n.t(:new_project_description_id_212), :name=>I18n.t(:new_project_name_id_212), :price=>20.0}
    @neighborhoods[10][:priorities] << {:id=>213, :letter=>"n", :link=>"", :description=>I18n.t(:new_project_description_id_213), :name=>I18n.t(:new_project_name_id_213), :price=>2.0}
    @neighborhoods[10][:priorities] << {:id=>214, :letter=>"o", :link=>"", :description=>I18n.t(:new_project_description_id_214), :name=>I18n.t(:new_project_name_id_214), :price=>3.0}
    @neighborhoods[10][:priorities] << {:id=>215, :letter=>"p", :link=>"", :description=>I18n.t(:new_project_description_id_215), :name=>I18n.t(:new_project_name_id_215), :price=>3.0}
    @neighborhoods[10][:priorities] << {:id=>216, :letter=>"q", :link=>"", :description=>I18n.t(:new_project_description_id_216), :name=>I18n.t(:new_project_name_id_216), :price=>0.8}
    @neighborhoods[10][:priorities] << {:id=>217, :letter=>"r", :link=>"", :description=>I18n.t(:new_project_description_id_217), :name=>I18n.t(:new_project_name_id_217), :price=>3.0}
    @neighborhoods[10][:priorities] << {:id=>218, :letter=>"s", :link=>"", :description=>I18n.t(:new_project_description_id_218), :name=>I18n.t(:new_project_name_id_218), :price=>5.0}
    @neighborhoods[10][:priorities] << {:id=>219, :letter=>"t", :link=>"", :description=>I18n.t(:new_project_description_id_219), :name=>I18n.t(:new_project_name_id_219), :price=>10.0}
    @neighborhoods[10][:priorities] << {:id=>220, :letter=>"u", :link=>"", :description=>I18n.t(:new_project_description_id_220), :name=>I18n.t(:new_project_name_id_220), :price=>10.0}
    @neighborhoods[10][:priorities] << {:id=>221, :letter=>"v", :link=>"", :description=>I18n.t(:new_project_description_id_221), :name=>I18n.t(:new_project_name_id_221), :price=>3.0}
    @neighborhoods[10][:priorities] << {:id=>222, :letter=>"w", :link=>"", :description=>I18n.t(:new_project_description_id_222), :name=>I18n.t(:new_project_name_id_222), :price=>2.0}
    @neighborhoods[10][:priorities] << {:id=>223, :letter=>"x", :link=>"", :description=>I18n.t(:new_project_description_id_223), :name=>I18n.t(:new_project_name_id_223), :price=>12.0}
    @neighborhoods[10][:priorities] << {:id=>224, :letter=>"y", :link=>"", :description=>I18n.t(:new_project_description_id_224), :name=>I18n.t(:new_project_name_id_224), :price=>1.0}
    @neighborhoods[10][:priorities] << {:id=>225, :letter=>"z", :link=>"", :description=>I18n.t(:new_project_description_id_225), :name=>I18n.t(:new_project_name_id_225), :price=>4.0}
    @neighborhoods[10][:priorities] << {:id=>226, :letter=>"0", :link=>"", :description=>I18n.t(:new_project_description_id_226), :name=>I18n.t(:new_project_name_id_226), :price=>15.0}
    @neighborhoods[10][:priorities] << {:id=>227, :letter=>"1", :link=>"", :description=>I18n.t(:new_project_description_id_227), :name=>I18n.t(:new_project_name_id_227), :price=>2.0}
    @neighborhoods[10][:priorities] << {:id=>228, :letter=>"2", :link=>"", :description=>I18n.t(:new_project_description_id_228), :name=>I18n.t(:new_project_name_id_228), :price=>3.0}
    @neighborhoods[10][:priorities] << {:id=>229, :letter=>"3", :link=>"", :description=>I18n.t(:new_project_description_id_229), :name=>I18n.t(:new_project_name_id_229), :price=>3.0}  end
