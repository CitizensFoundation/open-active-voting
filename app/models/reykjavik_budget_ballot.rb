...
#  attr_reader :maintenance_priorities
  ...
  def initialize(neighborhood_id=1)
    ...
    @neighborhoods[6][:construction_priorities] << {:id=>95, :letter=>"a", :link=>"http://betri-hverfi-hlidar.betrireykjavik.is/priorities/925-hundagerdi-a-klambratuni", :description=>I18n.t(:new_project_description_id_95), :name=>I18n.t(:new_project_name_id_95), :price=>6.0}
    @neighborhoods[6][:construction_priorities] << {:id=>96, :letter=>"b", :link=>"-- no Hyperlink --", :description=>I18n.t(:new_project_description_id_96), :name=>I18n.t(:new_project_name_id_96), :price=>2.5}
    ...
    @neighborhoods[6][:maintenance_priorities] << {:id=>100, :letter=>"a", :link=>"http://betri-hverfi-hlidar.betrireykjavik.is/priorities/922-grodursetja-tre-og-runna-a-leiksvaedi-leikskolans-klambra", :description=>I18n.t(:new_project_description_id_100), :name=>I18n.t(:new_project_name_id_100), :price=>10.0}
    @neighborhoods[6][:maintenance_priorities] << {:id=>101, :letter=>"b", :link=>"http://betri-hverfi-hlidar.betrireykjavik.is/priorities/1023-leikskolinn-hlid-gardur-vid-solhlid", :description=>I18n.t(:new_project_description_id_101), :name=>I18n.t(:new_project_name_id_101), :price=>1.0}
    @neighborhoods[6][:maintenance_priorities] << {:id=>102, :letter=>"c", :link=>"-- no Hyperlink --", :description=>I18n.t(:new_project_description_id_102), :name=>I18n.t(:new_project_name_id_102), :price=>2.5}
    ...
    @neighborhoods[7][:maintenance_priorities] << {:id=>113, :letter=>"a", :link=>"http://betri-hverfi-kjalarnes.betrireykjavik.is/priorities/849-endurbaetur-a-sundlauginni-", :description=>I18n.t(:new_project_description_id_113), :name=>I18n.t(:new_project_name_id_113), :price=>1.0}
    @neighborhoods[7][:maintenance_priorities] << {:id=>114, :letter=>"b", :link=>"http://betri-hverfi-kjalarnes.betrireykjavik.is/priorities/870-betri-lysing-a-gonguleidum-i-hverfinu", :description=>I18n.t(:new_project_description_id_114), :name=>I18n.t(:new_project_name_id_114), :price=>2.0}
    @neighborhoods[7][:maintenance_priorities] << {:id=>115, :letter=>"c", :link=>"http://betri-hverfi-kjalarnes.betrireykjavik.is/priorities/1132-lagfaera-gongustig-medfram-sjo-vid-grundarhverfi", :description=>I18n.t(:new_project_description_id_115), :name=>I18n.t(:new_project_name_id_115), :price=>0.4}
    @neighborhoods[7][:maintenance_priorities] << {:id=>116, :letter=>"d", :link=>"-- no Hyperlink --", :description=>I18n.t(:new_project_description_id_116), :name=>I18n.t(:new_project_name_id_116), :price=>1.0}
    ...
    @neighborhoods[8][:construction_priorities] << {:id=>121, :letter=>"a", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/843-hundagerdi-i-laugardalnum", :description=>I18n.t(:new_project_description_id_121), :name=>I18n.t(:new_project_name_id_121), :price=>1.0}
    @neighborhoods[8][:construction_priorities] << {:id=>122, :letter=>"b", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1125-utiadstada-fyrir-alla-fjolskylduna-i-laugardalinn", :description=>I18n.t(:new_project_description_id_122), :name=>I18n.t(:new_project_name_id_122), :price=>2.5}
    @neighborhoods[8][:construction_priorities] << {:id=>123, :letter=>"c", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/914-gonguljos-vid-gatnamotin-a-hofteig-og-reykjaveg", :description=>I18n.t(:new_project_description_id_123), :name=>I18n.t(:new_project_name_id_123), :price=>2.5}
    @neighborhoods[8][:construction_priorities] << {:id=>124, :letter=>"d", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1119-baeta-tengingu-langholtsvegar-vid-hjolreidastigin-vid-saebraut", :description=>I18n.t(:new_project_description_id_124), :name=>I18n.t(:new_project_name_id_124), :price=>11.0}
    @neighborhoods[8][:construction_priorities] << {:id=>125, :letter=>"e", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1010-gonguljos-og-lysing-vid-gatnamot-kirkjuteigs-og-reykjavegar", :description=>I18n.t(:new_project_description_id_125), :name=>I18n.t(:new_project_name_id_125), :price=>1.5}
    @neighborhoods[8][:construction_priorities] << {:id=>126, :letter=>"f", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/812-setja-upp-korfur-a-malbikudum-velli-sem-er-a-bakvid-drekavog", :description=>I18n.t(:new_project_description_id_126), :name=>I18n.t(:new_project_name_id_126), :price=>11.0}
    @neighborhoods[8][:construction_priorities] << {:id=>127, :letter=>"g", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1102-honnunarsmidja-vegna-torgs-a-motum-skeidarvogs-og-gnodarvogs", :description=>I18n.t(:new_project_description_id_127), :name=>I18n.t(:new_project_name_id_127), :price=>0.5}
    @neighborhoods[8][:construction_priorities] << {:id=>128, :letter=>"h", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1034-baett-lysing-a-horni-skeidarvogs-og-solheima", :description=>I18n.t(:new_project_description_id_128), :name=>I18n.t(:new_project_name_id_128), :price=>1.0}
    @neighborhoods[8][:construction_priorities] << {:id=>129, :letter=>"i", :link=>"-- no Hyperlink --", :description=>I18n.t(:new_project_description_id_129), :name=>I18n.t(:new_project_name_id_129), :price=>0.3}
    ...
    @neighborhoods[8][:maintenance_priorities] << {:id=>134, :letter=>"a", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1047-fleiri-og-staerri-ruslafotur-allt-fra-laugardalslaug-glaesibae", :description=>I18n.t(:new_project_description_id_134), :name=>I18n.t(:new_project_name_id_134), :price=>1.0}
    @neighborhoods[8][:maintenance_priorities] << {:id=>135, :letter=>"b", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/591-fleiri-bekkir-i-hverfid-her-er-margt-um-eldra-folk-", :description=>I18n.t(:new_project_description_id_135), :name=>I18n.t(:new_project_name_id_135), :price=>0.5}
    @neighborhoods[8][:maintenance_priorities] << {:id=>136, :letter=>"c", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1085-endurbaetur-a-leikvelli-milli-austurbrunar-og-kambsvegs", :description=>I18n.t(:new_project_description_id_136), :name=>I18n.t(:new_project_name_id_136), :price=>5.0}
    @neighborhoods[8][:maintenance_priorities] << {:id=>137, :letter=>"d", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1069-leiksvaedi-a-tuninu-fyrir-framan-laugarneskirkju", :description=>I18n.t(:new_project_description_id_137), :name=>I18n.t(:new_project_name_id_137), :price=>5.0}
    @neighborhoods[8][:maintenance_priorities] << {:id=>138, :letter=>"e", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1100-laga-stofnstig-fra-skeidarvogi-ad-sudurlandsbraut-", :description=>I18n.t(:new_project_description_id_138), :name=>I18n.t(:new_project_name_id_138), :price=>5.0}
    @neighborhoods[8][:maintenance_priorities] << {:id=>139, :letter=>"f", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1101-honnunarsmidja-vegna-torgs-a-snekkjuvogi-og-langholtsv-", :description=>I18n.t(:new_project_description_id_139), :name=>I18n.t(:new_project_name_id_139), :price=>4.0}
    @neighborhoods[8][:maintenance_priorities] << {:id=>140, :letter=>"g", :link=>"-- no Hyperlink --", :description=>I18n.t(:new_project_description_id_140), :name=>I18n.t(:new_project_name_id_140), :price=>1.0}
    @neighborhoods[8][:maintenance_priorities] << {:id=>141, :letter=>"h", :link=>"http://betri-hverfi-laugardalur.betrireykjavik.is/priorities/1148-mala-aftur-hjolavisar-i-hverfinu", :description=>I18n.t(:new_project_description_id_141), :name=>I18n.t(:new_project_name_id_141), :price=>4.5}
    ...
    @neighborhoods[8][:maintenance_priorities] << {:id=>143, :letter=>"j", :link=>"-- no Hyperlink --", :description=>I18n.t(:new_project_description_id_143), :name=>I18n.t(:new_project_name_id_143), :price=>2.0}
    ...
    @neighborhoods[9][:construction_priorities] << {:id=>147, :letter=>"a", :link=>"http://betri-hverfi-midborg.betrireykjavik.is/priorities/1113-gangstettir-nedst-a-frakkastig-og-klapparstig", :description=>I18n.t(:new_project_description_id_147), :name=>I18n.t(:new_project_name_id_147), :price=>2.5}
    @neighborhoods[9][:construction_priorities] << {:id=>148, :letter=>"b", :link=>"-- no Hyperlink --", :description=>I18n.t(:new_project_description_id_148), :name=>I18n.t(:new_project_name_id_148), :price=>2.5}
    ...
    @neighborhoods[9][:maintenance_priorities] << {:id=>151, :letter=>"a", :link=>"http://betri-hverfi-midborg.betrireykjavik.is/priorities/1067-fleiri-ruslafotur-i-midbaeinn", :description=>I18n.t(:new_project_description_id_151), :name=>I18n.t(:new_project_name_id_151), :price=>1.0}
    @neighborhoods[9][:maintenance_priorities] << {:id=>152, :letter=>"b", :link=>"http://betri-hverfi-midborg.betrireykjavik.is/priorities/1068-fleiri-hjolagrindur", :description=>I18n.t(:new_project_description_id_152), :name=>I18n.t(:new_project_name_id_152), :price=>1.0}
    @neighborhoods[9][:maintenance_priorities] << {:id=>153, :letter=>"c", :link=>"http://betri-hverfi-midborg.betrireykjavik.is/priorities/928-ad-steinhledslur-vid-tjarnarkantinn-verdi-lagfaerdar", :description=>I18n.t(:new_project_description_id_153), :name=>I18n.t(:new_project_name_id_153), :price=>2.0}
    @neighborhoods[9][:maintenance_priorities] << {:id=>154, :letter=>"d", :link=>"http://betri-hverfi-midborg.betrireykjavik.is/priorities/1071-meiri-grodur-a-laekjartorg-og-i-austurstraeti", :description=>I18n.t(:new_project_description_id_154), :name=>I18n.t(:new_project_name_id_154), :price=>5.0}
    @neighborhoods[9][:maintenance_priorities] << {:id=>155, :letter=>"e", :link=>"http://betri-hverfi-midborg.betrireykjavik.is/priorities/953-ad-fyrirbaerid-torg-eitthvad-vid-3-frakka-verdi-lagfaert", :description=>I18n.t(:new_project_description_id_155), :name=>I18n.t(:new_project_name_id_155), :price=>2.0}
    @neighborhoods[9][:maintenance_priorities] << {:id=>156, :letter=>"f", :link=>"-- no Hyperlink --", :description=>I18n.t(:new_project_description_id_156), :name=>I18n.t(:new_project_name_id_156), :price=>1.0}
    ...
    @neighborhoods[10][:construction_priorities] << {:id=>161, :letter=>"a", :link=>"http://betri-hverfi-vesturbaer.betrireykjavik.is/priorities/733-threp-mhandridi-nidur-i-fjoru-a-23-stodum-veidisgranda", :description=>I18n.t(:new_project_description_id_161), :name=>I18n.t(:new_project_name_id_161), :price=>4.0}
    @neighborhoods[10][:construction_priorities] << {:id=>162, :letter=>"b", :link=>"http://betri-hverfi-vesturbaer.betrireykjavik.is/priorities/717-bua-til-threp-nidur-i-fjoru-i-skerjafirdi-vid-shell-itr-", :description=>I18n.t(:new_project_description_id_162), :name=>I18n.t(:new_project_name_id_162), :price=>2.0}
    @neighborhoods[10][:construction_priorities] << {:id=>163, :letter=>"c", :link=>"http://betri-hverfi-vesturbaer.betrireykjavik.is/priorities/597-betri-adgangur-gangandi-og-hjolandi-yfir-a-fiskislod", :description=>I18n.t(:new_project_description_id_163), :name=>I18n.t(:new_project_name_id_163), :price=>1.0}
    @neighborhoods[10][:construction_priorities] << {:id=>164, :letter=>"d", :link=>"-- no Hyperlink --", :description=>I18n.t(:new_project_description_id_164), :name=>I18n.t(:new_project_name_id_164), :price=>3.0}
    ...
    @neighborhoods[10][:maintenance_priorities] << {:id=>171, :letter=>"a", :link=>"http://betri-hverfi-vesturbaer.betrireykjavik.is/priorities/1065-endurgera-rolo-a-milli-nylendugotu-og-vesturgotu", :description=>I18n.t(:new_project_description_id_171), :name=>I18n.t(:new_project_name_id_171), :price=>2.5}
    @neighborhoods[10][:maintenance_priorities] << {:id=>172, :letter=>"b", :link=>"http://betri-hverfi-vesturbaer.betrireykjavik.is/priorities/1143-leiksvaedi-fyrir-born-a-graenu-svaedi-vid-aflagranda-40", :description=>I18n.t(:new_project_description_id_172), :name=>I18n.t(:new_project_name_id_172), :price=>2.0}
    @neighborhoods[10][:maintenance_priorities] << {:id=>173, :letter=>"c", :link=>"http://betri-hverfi-vesturbaer.betrireykjavik.is/priorities/869-staerri-ruslakassi-vid-straetoskylid-vid-haskolann", :description=>I18n.t(:new_project_description_id_173), :name=>I18n.t(:new_project_name_id_173), :price=>5.0}
    @neighborhoods[10][:maintenance_priorities] << {:id=>174, :letter=>"d", :link=>"http://betri-hverfi-vesturbaer.betrireykjavik.is/priorities/1007-laga-fotboltavoll-og-leiksvaedi-vid-reynimel-6874", :description=>I18n.t(:new_project_description_id_174), :name=>I18n.t(:new_project_name_id_174), :price=>0.2}
    @neighborhoods[10][:maintenance_priorities] << {:id=>175, :letter=>"e", :link=>"http://betri-hverfi-vesturbaer.betrireykjavik.is/priorities/761-lysing-a-leikvoll-vid-bauganes", :description=>I18n.t(:new_project_description_id_175), :name=>I18n.t(:new_project_name_id_175), :price=>2.0}
    @neighborhoods[10][:maintenance_priorities] << {:id=>176, :letter=>"f", :link=>"-- no Hyperlink --", :description=>I18n.t(:new_project_description_id_176), :name=>I18n.t(:new_project_name_id_176), :price=>0.5}
