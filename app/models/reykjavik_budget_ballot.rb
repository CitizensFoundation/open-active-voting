...
class ReykjavikBudgetBallot
  ...
  def initialize(neighborhood_id=1)
    ...
    @neighborhoods[4][:priorities] << {:id=>63, :letter=>"a", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/2119-fjolbreytan-trjagrodur-fyrir-ofan-vesturlandsveg-fra-grafarholti-og-ad-skograektinni-vid-hamragarda-med-aherslu-a-svaedid-fra-akveginum-og-ad-nyja-gongustignum-", :description=>I18n.t(:new_project_description_id_63), :name=>I18n.t(:new_project_name_id_63), :price=>2.0}
    @neighborhoods[4][:priorities] << {:id=>64, :letter=>"b", :link=>"", :description=>I18n.t(:new_project_description_id_64), :name=>I18n.t(:new_project_name_id_64), :price=>3.5}
    @neighborhoods[4][:priorities] << {:id=>65, :letter=>"c", :link=>"", :description=>I18n.t(:new_project_description_id_65), :name=>I18n.t(:new_project_name_id_65), :price=>1.0}
    @neighborhoods[4][:priorities] << {:id=>66, :letter=>"d", :link=>"", :description=>I18n.t(:new_project_description_id_66), :name=>I18n.t(:new_project_name_id_66), :price=>1.5}
    @neighborhoods[4][:priorities] << {:id=>67, :letter=>"e", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/1761-fleiri-tre-vid-gongustig-sem-liggur-fyrir-ofan-gylfaflot-og-nedan-langarima", :description=>I18n.t(:new_project_description_id_67), :name=>I18n.t(:new_project_name_id_67), :price=>2.0}
    @neighborhoods[4][:priorities] << {:id=>68, :letter=>"f", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/1800-gongustigur-medfram-kirkjugardinum-vid-borgarveg", :description=>I18n.t(:new_project_description_id_68), :name=>I18n.t(:new_project_name_id_68), :price=>14.0}
    @neighborhoods[4][:priorities] << {:id=>69, :letter=>"g", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/1912-umferdarspegill", :description=>I18n.t(:new_project_description_id_69), :name=>I18n.t(:new_project_name_id_69), :price=>0.5}
    @neighborhoods[4][:priorities] << {:id=>70, :letter=>"h", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/1918-ljuka-vid-grodurbelti-medfram-ithrottasvaedi-fjolnis-vid-logafold-og-reykjafold-", :description=>I18n.t(:new_project_description_id_70), :name=>I18n.t(:new_project_name_id_70), :price=>2.0}
    @neighborhoods[4][:priorities] << {:id=>71, :letter=>"i", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/1947-umhirda-a-graenu-svaedi-nedst-i-gotu-a-milli-fletturima-og-berjarima", :description=>I18n.t(:new_project_description_id_71), :name=>I18n.t(:new_project_name_id_71), :price=>4.0}
    @neighborhoods[4][:priorities] << {:id=>72, :letter=>"j", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/1967-trjagrodur-til-skjolmyndunar-gegn-naatt-i-grafarvogshverfi", :description=>I18n.t(:new_project_description_id_72), :name=>I18n.t(:new_project_name_id_72), :price=>3.0}
    @neighborhoods[4][:priorities] << {:id=>73, :letter=>"k", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/1968-endurnyjun-skolalodar-husaskola", :description=>I18n.t(:new_project_description_id_73), :name=>I18n.t(:new_project_name_id_73), :price=>10.0}
    @neighborhoods[4][:priorities] << {:id=>74, :letter=>"l", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/1969-fegra-umhverfi-grafarvogslaugar", :description=>I18n.t(:new_project_description_id_74), :name=>I18n.t(:new_project_name_id_74), :price=>1.0}
    @neighborhoods[4][:priorities] << {:id=>75, :letter=>"m", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/1985-utitafl-vid-rimaskola", :description=>I18n.t(:new_project_description_id_75), :name=>I18n.t(:new_project_name_id_75), :price=>3.0}
    @neighborhoods[4][:priorities] << {:id=>76, :letter=>"n", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/1990-vantar-ljos-vid-gonguhjolastig", :description=>I18n.t(:new_project_description_id_76), :name=>I18n.t(:new_project_name_id_76), :price=>10.0}
    @neighborhoods[4][:priorities] << {:id=>77, :letter=>"o", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/2068-gonguljos-vid-olis-fjallkonuveg", :description=>I18n.t(:new_project_description_id_77), :name=>I18n.t(:new_project_name_id_77), :price=>12.0}
    @neighborhoods[4][:priorities] << {:id=>78, :letter=>"p", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/2147-grodursetja-tre-vid-strandstig-nedan-stadahverfis", :description=>I18n.t(:new_project_description_id_78), :name=>I18n.t(:new_project_name_id_78), :price=>2.0}
    @neighborhoods[4][:priorities] << {:id=>79, :letter=>"q", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/2213-merkingar-og-grodur-hja-styttugardinum", :description=>I18n.t(:new_project_description_id_79), :name=>I18n.t(:new_project_name_id_79), :price=>2.0}
    @neighborhoods[4][:priorities] << {:id=>80, :letter=>"r", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/2221-hundagerdi-i-grafarvoginn-og-thad-strax", :description=>I18n.t(:new_project_description_id_80), :name=>I18n.t(:new_project_name_id_80), :price=>3.5}
    @neighborhoods[4][:priorities] << {:id=>81, :letter=>"s", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/2261-vatnshani-innst-i-grafarvogi", :description=>I18n.t(:new_project_description_id_81), :name=>I18n.t(:new_project_name_id_81), :price=>5.0}
    @neighborhoods[4][:priorities] << {:id=>82, :letter=>"t", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/2287-auka-oryggi-gangandi-a-gongustigum-i-stadarhverfi-vid-golfvoll", :description=>I18n.t(:new_project_description_id_82), :name=>I18n.t(:new_project_name_id_82), :price=>3.0}
    @neighborhoods[4][:priorities] << {:id=>83, :letter=>"u", :link=>"http://betri-hverfi-grafarvogur.betrireykjavik.is/ideas/2290-lagfaeringar-a-geirsnefi", :description=>I18n.t(:new_project_description_id_83), :name=>I18n.t(:new_project_name_id_83), :price=>5.0}
    @neighborhoods[4][:priorities] << {:id=>84, :letter=>"v", :link=>"http://betrireykjavik.is/ideas/1801-gangbrautarljos-a-fjallkonuveg-vid-joklafold", :description=>I18n.t(:new_project_description_id_84), :name=>I18n.t(:new_project_name_id_84), :price=>12.0}
    @neighborhoods[4][:priorities] << {:id=>85, :letter=>"w", :link=>"http://betrireykjavik.is/ideas/1862-setja-upp-hlid-a-gongustig-a-milli-rimaskola-og-midgardslangarima-vegna-mikillar-motorhjolaumferdar-um-gangstiginn", :description=>I18n.t(:new_project_description_id_85), :name=>I18n.t(:new_project_name_id_85), :price=>0.7}
    @neighborhoods[4][:priorities] << {:id=>86, :letter=>"x", :link=>"http://betrireykjavik.is/ideas/1944-gangbrautarljos-vid-gagnveg-i-grafarvogi", :description=>I18n.t(:new_project_description_id_86), :name=>I18n.t(:new_project_name_id_86), :price=>12.0}
    @neighborhoods[4][:priorities] << {:id=>87, :letter=>"y", :link=>"http://betrireykjavik.is/ideas/2157-malbika-malarstig-milli-hamrahverfis-ad-gufunesbaejar", :description=>I18n.t(:new_project_description_id_87), :name=>I18n.t(:new_project_name_id_87), :price=>10.0}
    @neighborhoods[4][:priorities] << {:id=>88, :letter=>"z", :link=>"http://betrireykjavik.is/ideas/2174-haekkun-hljodmanar-milli-stakkhamra-og-gullinbruarstrandvegar", :description=>I18n.t(:new_project_description_id_88), :name=>I18n.t(:new_project_name_id_88), :price=>6.0}
